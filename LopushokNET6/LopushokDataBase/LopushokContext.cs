...
namespace Lopushok.LopushokDataBase
{
    public partial class LopushokContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data source=DESKTOP-OD8ATN8\\SQLEXPRESS;Initial Catalog=Lopushok;Trusted_Connection=true");
            }
        }
